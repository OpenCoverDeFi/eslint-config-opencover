...
import { getParserServices, getTypeFromESTreeNode, isTypeNullable } from '@/plugin/utils.js';
...
export const rule: RuleDefinition<Options> = {
    ...
    meta: {
        ...
        docs: {
            ...
            url: 'https://opencover.com/development/rules/no-unnecessary-optional-chain',
        },
        messages: {
