...
describe('stylistic', () => {
    describe('stylistic/quotes', () => {
        it('enforces single quotes', async () => {
            const results = await lint('const x = "hello";', 'tests/stylistic.test.ts');
        ...
        it('allows single quotes', async () => {
            const results = await lint("const _x = 'hello';", 'tests/stylistic.test.ts');
    ...
    describe('stylistic/semi', () => {
        it('requires semicolons', async () => {
            const results = await lint('const x = 1', 'tests/stylistic.test.ts');
        ...
        it('allows semicolons', async () => {
            const results = await lint('const _x = 1;', 'tests/stylistic.test.ts');
    ...
    describe('stylistic/spaced-comment', () => {
        it('requires space after //', async () => {
            const results = await lint('//not fine', 'tests/stylistic.test.ts');
        ...
        it('allows space after //', async () => {
            const results = await lint('// Fine', 'tests/stylistic.test.ts');
    ...
    describe('stylistic/lines-between-class-members', () => {
        it('requires blank line between multi-line class members', async () => {
            ...
            const results = await lint(code, 'tests/stylistic.test.ts');
    ...
    describe('stylistic/padding-line-between-statements', () => {
        it('requires blank line before function', async () => {
            const results = await lint('const x = 1;\nfunction foo() {}', 'tests/stylistic.test.ts');
        ...
        it('requires blank line before export', async () => {
            const results = await lint('const x = 1;\nexport { x };', 'tests/stylistic.test.ts');
        ...
        it('requires blank line before class', async () => {
            const results = await lint('const _x = 1;\nclass Foo {}', 'tests/stylistic.test.ts');
